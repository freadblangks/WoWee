...
void OpcodeTable::loadWotlkDefaults() {
    ...
    struct { LogicalOpcode op; uint16_t wire; } defaults[] = {
        ...
        {LogicalOpcode::SMSG_FEATURE_SYSTEM_STATUS, 0x3C9},
        ...
        {LogicalOpcode::CMSG_GUILD_QUERY, 0x054},
        {LogicalOpcode::SMSG_GUILD_QUERY_RESPONSE, 0x055},
        ...
        {LogicalOpcode::SMSG_SPELLENERGIZELOG, 0x151},
        ...
        {LogicalOpcode::MSG_TALENT_WIPE_CONFIRM, 0x2AA},
        ...
        {LogicalOpcode::SMSG_PARTY_COMMAND_RESULT, 0x07F},
        ...
        {LogicalOpcode::CMSG_ACTIVATETAXI, 0x1AD},
        ...
        {LogicalOpcode::SMSG_QUESTGIVER_STATUS_MULTIPLE, 0x418},
        {LogicalOpcode::CMSG_QUESTGIVER_HELLO, 0x184},
        {LogicalOpcode::SMSG_QUESTGIVER_QUEST_LIST, 0x185},
        ...
        {LogicalOpcode::SMSG_QUESTUPDATE_ADD_KILL, 0x199},
        {LogicalOpcode::SMSG_QUESTUPDATE_ADD_ITEM, 0x197},
        {LogicalOpcode::SMSG_QUESTUPDATE_COMPLETE, 0x198},
        ...
        {LogicalOpcode::SMSG_QUESTLOG_FULL, 0x195},
